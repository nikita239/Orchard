  ...
  <system.webServer>
    <handlers accessPolicy=""Script"">
      ...
      <add name=""NotFound"" path=""*"" verb=""*"" type=""System.Web.HttpNotFoundHandler"" preCondition=""integratedMode"" requireAccess=""Script""/>
        ...
        public IStorageFile GetJournalFile(string executionId) {
        ...
        public static string ReadJournal(IStorageFile executionJournal) {
        ...
        public static void WriteJournal(IStorageFile journalFile, XElement journal) {
