...
namespace Orchard.DesignerTools.Services {
    ...
    public class ObjectDumper {
        ...
        public void DumpValue(object o, string name) {
        ...
        public void DumpObject(object o, string name)
        {
            _current.Add(
                new XElement("h1", new XText(name))
        ...
        public void DumpMembers(object o) {
        ...
        public void DumpEnumerable(IEnumerable enumerable) {
        ...
        public void DumpDictionary(IDictionary dictionary) {
        ...
        public void DumpShape(IShape shape) {
        ...
        public void DumpMember(object o, MemberInfo member) {
